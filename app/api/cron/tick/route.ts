...
import { runTick, runDailyBrief, proactiveCheckin, runWeeklyPlanning, runMoodCheckins, runDailyDigest, JOB_HANDLERS } from "@/lib/proactive";
...
async function handle(req: NextRequest) {
  ...
  if (force === "digest") return NextResponse.json({ ok: true, forced: "digest", built: await runDailyDigest(true) });
